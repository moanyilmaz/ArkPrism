...
\Description{A two-row pipeline showing ArkTS project and analysis-specification inputs, the ArkAnalyzer frontend, evidence-carrying API identity resolution, carrier and context recovery, query-aware flow analysis, provenance-preserving evidence assembly, and JSON, DOT, and manifest audit artifacts.}
