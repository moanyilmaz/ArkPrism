...
\caption{Source patterns and their recognition evidence.}
\Description{A two-panel example showing ArkTS source patterns and ArkPrism recognition steps for import normalization, manager receiver recovery, IR alias recovery, and sink evidence.}
